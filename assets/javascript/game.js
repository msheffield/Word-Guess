...
var hiddenWord = {
    ...
    word: [],
    pastWords: [],
    // COLLAPSE THIS!!! I'm sorry I tried to include it in another file but had trouble importing. Maybe I will fix in class...
    wordList: [
        // Borrowed from npm random-words
    ...
    wordGen() {
        ...
        if (this.pastWords.includes(newWord)) {
            wordGen(this.wordList);
        }
